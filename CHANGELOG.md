...
- Mesh and interface telemetry becomes unavailable after three failed source
  refreshes instead of remaining stale indefinitely.
- Failed persistence of the router out-of-memory diagnostic is retried on the
  next refresh.
